    ...
    init: (cfg, defs) =>        
        ...
        super cfg,
            ...
            children :
                [
                    type  : 'img'
                    src   : '../../img/menuicon@2x.png'
                ,
                    type  : 'button'
                    child :
                        text : 'Home'
                    action: () -> knix.openURL "https://monsterkodi.github.io/kugel"
                ,
                ...
                ,
                    ...
                    child :
                        text : 'Credits'
                    action: () -> knix.openURL "https://monsterkodi.github.io/kugel/credits.html"
                ,
                    type  : 'about-svg'
                ...
                ,
                    ...
                    child :
                        text : 'GitHub'
                    action : () -> knix.openURL "https://github.com/monsterkodi/kugel"
                ,
                    style :
                        textAlign : 'center'
                    child :
